...
public class Seleccion {
    ...
    // Constructor con solo datos primitivos y Strings
    /**
     * Crea una instancia de {@code Seleccion} con los datos indicados.
     *
    ...
    /**
     * Devuelve ranking f i f a.
     * @return ranking f i f a
     */
    public int getRankingFIFA() { return rankingFIFA; }

    /**
     * Establece ranking f i f a.
     *
     * @param rankingFIFA rankingFIFA
     */
    ...
    /**
     * Agrega un director tecnico a la seleccion y establece la relacion inversa.
     *
     * @param DT DT
     */
    ...
    /**
     * Agrega un integrante del cuerpo tecnico y establece la relacion inversa.
     *
     * @param CT CT
     */
    ...
    /**
     * Agrega una participacion a la seleccion y establece la relacion inversa.
     *
