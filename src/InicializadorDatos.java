public class InicializadorDatos {
    /**
    * Método estático que se encarga de poblar el sistema con datos de prueba (Mock Data).
    * Cumple con la buena práctica de aislar la carga de datos ("hardcodeo") de la lógica de negocio.
    */
    ...
    public static void cargarDatosDePrueba(GestionDelegaciones gestoraDelegaciones,
        ...
        try {
            ...
            // ==========================================================
            // (Usamos enteros para las fechas como definiste en tu UML: ej. 20260611)
            ...
            // Planificamos el partido (Argentina vs Brasil)
            Partido partidoClasico = gestoraDeportiva.planificarPartido(
                    20260615, 1600, 90, 5,
                    monumental, faseGrupos, partLocalArg, partVisitaBra);

            // ==========================================================
            // 5. ÁRBITROS (Requisito para evitar tu PartidoSinArbitroPrincipalException)
            // ==========================================================
            ...
            // ==========================================================
            // 6. EVENTOS (Opcional, para que haya datos en los reportes)
            // ==========================================================
            // Obtenemos a Messi (índice 0 de la lista de jugadores de Argentina)
